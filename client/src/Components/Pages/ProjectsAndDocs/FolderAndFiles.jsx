...
const FolderAndFiles = ({temp , controls , Home , setHome , selected , folderAndFiles , setFolderAndFiles}) => {
...
const Folder = ({e , setFolderAndFiles , setHome , folderAndFiles}) => {
    ...
    return <Box onClick={() => handleOnClick(e.name)} sx={{bgcolor:"#f1f5f9", height:"150px" , width:"160px" , borderRadius:"10px" , ml:1 , mt:2 , cursor:"pointer"}}>
    <Box>
        <BsPatchExclamationFill style={{paddingLeft:"135" , paddingTop:"10px"}}/>
    </Box>
    <FcOpenedFolder fontSize={60} style={{marginLeft:"47px"}}/>
    <Typography sx={{fontSize:"14px" , ml:"50px" , mt:"4px"}}>{e.name}</Typography>
    <Typography fontSize={12} ml={6.9}>57 Files</Typography>
</Box>
}

const Files = ({e , setHome}) =>{
    return<Box sx={{bgcolor:"#f1f5f9" , height:"150px" , width:"160px" , borderRadius:"10px" , ml:1 , mt:2}}>
    <Box>
        <BsPatchExclamationFill style={{paddingLeft:"135" , paddingTop:"10px"}}/>
    </Box>
    <FaFilePdf fontSize={60} style={{marginLeft:"47px" , color:"#263f59"}}/>
    <Typography sx={{fontSize:"14px" , ml:"50px" , mt:"4px"}}>{e.name}</Typography>
    <Typography fontSize={12} ml={6.9}>57 Files</Typography>
</Box>
}
